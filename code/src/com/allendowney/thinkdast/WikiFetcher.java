...
public class WikiFetcher {
    ...
    private volatile static WikiFetcher wikiFetcher;
    ...
    public static WikiFetcher getInstance() {
        if (wikiFetcher == null) {
            synchronized (WikiFetcher.class) {
                if (wikiFetcher == null) {
    ...
    public Elements fetchWikipedia(String url) throws IOException {
        ...
        // Element content = doc.getElementsByClass("main-content").first();
        Element content = doc.getElementById("mw-content-text");

        // TODO: avoid selecting paragraphs from sidebars and boxouts
        Elements paras = content.select("p");
        // Elements paras = content.getElementsByClass("lemma-summary");
        return paras;
    }
